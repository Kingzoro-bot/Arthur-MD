...
╰─────────────━┈⊷ `
            ...
            header: proto.Message.InteractiveMessage.Header.create({
                ...(await prepareWAMessageMedia({ image : fs.readFileSync('./src/arthur.jpg')}, { upload: Matrix.waUploadToServer})), 
                  title: ``,
                  gifPlayback: true,
                  subtitle: "",
              ...
              buttons: [
                {
                 ...
                 "sections":
                   [{
                    "title":"👑 ΛＲＴＨＵＲ-ＭＤ 𝛥𝐿𝐿𝛭𝛯𝛮𝑈",
                    "highlight_label":"🤩 𝛥𝐿𝐿𝛭𝛯𝛮𝑈",
                    "rows":[
                      {
                       "header":"",
                       "title":"🔰 ᴀʟʟ ᴍᴇɴᴜ",
                       "description":"🎨ΛＲＴＨＵＲ-ＭＤ 𝛥𝐿𝐿𝛭𝛯𝛮𝑈🎨",
                       "id":"View All Menu"
                      },
                      {
                        "header":"",
